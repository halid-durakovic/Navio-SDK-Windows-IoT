...
namespace Emlid.WindowsIot.Hardware.Filters
{
    /// <summary>
    ...
    public class MadgwickAHRS
    {
        ...
        public void Update(float gx, float gy, float gz, float ax, float ay, float az, float mx, float my, float mz)
        {
            ...
            Euler[0] = (float)Math.Atan2(Quaternion[0] * Quaternion[1] + Quaternion[2] * Quaternion[3], 0.5f - Quaternion[1] * Quaternion[1] - Quaternion[2] * Quaternion[2]); //roll
            Euler[1] = (float)Math.Asin(-2.0f * (Quaternion[1] * Quaternion[3] - Quaternion[0] * Quaternion[2])); //pitch
            Euler[2] = (float)Math.Atan2(Quaternion[1] * Quaternion[2] + Quaternion[0] * Quaternion[3], 0.5f - Quaternion[2] * Quaternion[2] - Quaternion[3] * Quaternion[3]); //yaw 
        }
