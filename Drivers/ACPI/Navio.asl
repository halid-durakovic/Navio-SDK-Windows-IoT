...
// NavioRP2.asl
// ----------------------------------------------------------------------------
// ACPI Machine Language (AML) source (ASL) for the Emlid Navio board,
// when attached (as designed) to the Raspberry Pi 2 motherboard.
// ----------------------------------------------------------------------------

DefinitionBlock ("NavioRP2.aml", "SSDT", 1, "EMLID", "NAVIO", 1)
{
    Scope (\_SB)
    {
        //
        // Navio peripheral device node for Raspberry Pi 2
        //
        Device(NAVI)
        {
            Name(_HID, "NAVI0001")
